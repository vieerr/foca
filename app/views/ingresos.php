    ...
    <section class="flex justify-between w-full mb-3">
      ...
      <dialog id="modalIngreso" class="modal">
        <div class="modal-box">
          ...
          <form id="register-income-form" class="w-full flex flex-col gap-2">
    ...
    <section class="mb-6">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <label class="select" for="filtro_nombre_categoria">
          <span class="label font-medium">Categoría</span>
          <select class="select" name="filtro_nombre_categoria" id="filtro_nombre_categoria"></select>
        </label>
      ...
      <table id="ingresos-table" class="table w-full bg-base-100">
        <thead>
          <tr class="text-center text-sm font-medium text-gray-700">
            ...
            <th class="px-6 py-3 border-b border-gray-200">Fecha de Obtención</th>
