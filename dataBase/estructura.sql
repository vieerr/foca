...
CREATE TABLE IF NOT EXISTS `economiaf`.`Auditoria` (
  ...
  INDEX `fk_id_usuario_auditoria_idx` (`id_usuario`),
...
-- Insertar Roles
INSERT INTO economiaf.Roles (nombre_rol, descripcion_rol, estado_rol) 
VALUES ('Administrador', 'Rol administrador completo', 'activo');
INSERT INTO economiaf.Roles (nombre_rol, descripcion_rol, estado_rol) 
VALUES ('Gerente', 'Rol con permisos limitados', 'activo');

-- Insertar Permisos
INSERT INTO economiaf.Permisos (nombre_permiso) VALUES ('crear_roles');
INSERT INTO economiaf.Permisos (nombre_permiso) VALUES ('ver_reportes');
INSERT INTO economiaf.Permisos (nombre_permiso) VALUES ('configurar');

INSERT INTO economiaf.Autorizaciones (id_rol, id_permiso) VALUES (2, 2); -- ver_reportes

-- Insertar Autorizaciones
-- Para el rol Administrador (se asume id_rol = 1)
INSERT INTO economiaf.Autorizaciones (id_rol, id_permiso) VALUES (1, 1); -- crear_roles
INSERT INTO economiaf.Autorizaciones (id_rol, id_permiso) VALUES (1, 2); -- ver_reportes
INSERT INTO economiaf.Autorizaciones (id_rol, id_permiso) VALUES (1, 3); -- configurar